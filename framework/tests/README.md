...
| 4 | Resolve strand ≠ generation | ⛔ **held open** | Conceptual; cannot be closed without the tension law. Filling it would violate the Variable Principle. |
...
| 6 | Open the CONTRIBUTING issue for rows 9–15 | ☐ **maintainer action** | Those are rows **8–14** in [`../registers.md`](../registers.md) — see the numbering note there. |
