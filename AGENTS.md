...
4. **[`versions/v5.4/GFunnel-Methodology-v5.4.md`](versions/v5.4/GFunnel-Methodology-v5.4.md)** — Run 8: the first run executed *with* the meta-tier, including §4a (Frequency) and §4b (the Anti-Triad). Derivations only; no new layer.
