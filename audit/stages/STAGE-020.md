...
6. Data (unfiltered): table above. Two CO2, three NADH, one reduced quinone, one ATP or GTP per turn. Net carbon balance: two CO2 per acetyl-CoA. Which carbon atoms leave in which turn (isotope tracing) was not fetched in this run.
...
- Test C (Direction): Forced for the oxidative direction canon describes. Whether the cycle also runs in reverse in some organisms was not checked in this run (held open).
- Test D (Falsifiability): Yes (step 3).
- **Outcome:** forced-fill.

## Anti-Operation (the gap this opens)
The KEGG module lists alternative enzymes (e.g. 2-oxoglutarate/2-oxoacid ferredoxin oxidoreductase, K00174/K00175, EC 1.2.7.3, in M00009; https://rest.kegg.jp/get/K00174, retrieved 2026-09-24). A ferredoxin-linked variant of the cycle is a variable canon's single forward-running "Krebs Cycle" stage does not hold, and it bears on whether the cycle predates oxygen (Stage 17). Held open; not measured here.
