...
| [v5.4](v5.4/GFunnel-Methodology-v5.4.md) | Run 8 — Line-Field · Knots · Lamina | The first run executed with the meta-tier. Motion as tying/untying; closure as the specific point; interaction rules; the mass-spectrum pattern; three test devices; thirteen logged retractions. No new architecture. |
